...
/* harmony export */ });
/* harmony import */ var _partials_page_controls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../partials/page-controls.js");
/* harmony import */ var _partials_header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../partials/header.js");
/* harmony import */ var smoothscroll_polyfill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("../../../node_modules/smoothscroll-polyfill/dist/smoothscroll.js");
...
var BasePage = /*#__PURE__*/function () {
  function BasePage(el) {
    _classCallCheck(this, BasePage);

    this.el = el;
    smoothscroll_polyfill__WEBPACK_IMPORTED_MODULE_2___default().polyfill();
    new _partials_header__WEBPACK_IMPORTED_MODULE_1__["default"](document.querySelector('.js-header'));
    new _partials_page_controls__WEBPACK_IMPORTED_MODULE_0__["default"](el);
...
var Header = function Header(el) {
  ...
  this.burger.addEventListener('click', function () {
    _this.el.classList.toggle(_this.navOpenClass);

    _this.el.classList.remove(_this.dropdownOpenClass);
  });
  this.dropdownOpeners.forEach(function (el) {
    el.addEventListener('click', function () {
      _this.el.classList.toggle(_this.dropdownOpenClass);
    });
  });
};
...
var PageControls = function PageControls(el) {
  var _this$sectionDetect,
      _this = this;
  ...
  (_this$sectionDetect = this.sectionDetect) === null || _this$sectionDetect === void 0 ? void 0 : _this$sectionDetect.classList.toggle(this.sectionDetectHiddenClass, window.scrollY < 680);
  var observerOptions = {
    threshold: 0.5
  };
    ...
    entries.forEach(function (entry) {
      if (entry && entry.isIntersecting) {
        _this.items.forEach(function (el) {
          ...
          var elSelector = href.replace('/#', '');
          var isActiveItem = elSelector === entry.target.id;
          el.classList.toggle(_this.activeSectionItemClass, isActiveItem);
          el.classList.toggle(_this.blackItemClass, elSelector === 'about');
        });

        var isRedWhiteToTop = entry.target.id === 'products' || entry.target.id === 'socials' || entry.target.id === 'contacts';
        var isRedGreyToTop = entry.target.id === 'write-to-us';

        _this.toTopBtn.classList.toggle(_this.toTopRedWhiteClass, isRedWhiteToTop);

        _this.toTopBtn.classList.toggle(_this.toTopRedGreyClass, isRedGreyToTop);
      }
    });
  }, observerOptions);
  ...
  window.addEventListener('scroll', function () {
    var _this$sectionDetect2;

    _this.toTopBtn.classList.toggle(_this.toTopHiddenClass, window.scrollY < 680);

    (_this$sectionDetect2 = _this.sectionDetect) === null || _this$sectionDetect2 === void 0 ? void 0 : _this$sectionDetect2.classList.toggle(_this.sectionDetectHiddenClass, window.scrollY < 680);
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PageControls);
